...
#include<stdlib.h>
using namespace std;
int mehraan = 0, m, Name = 0, Id = 0, Password = 0, Coroalla = 0, hhonda = 0, Ssuzuki = 0, LLoader = 0, TRUCK = 0, CD = 0,zz=0,kg=0,l,mn,bb;
string namee;
class Car_rental
{
	public :
...
public:
	int opt;
	string Mehhran[6]= { {"White 2013 HF-765"},{"Red 2001 HK-900"}, {"Black 2002 FG-566"},{"GREY 2019 KL-190"},{"White 2020 pp-098"},{"Green 2006 u-100"} };
